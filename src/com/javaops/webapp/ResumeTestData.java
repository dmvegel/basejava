...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.getSections().put(SectionType.OBJECTIVE, new Resume.TextSection("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям"));
        resume.getSections().put(SectionType.PERSONAL, new Resume.TextSection("Аналитический склад ума, сильная логика, креативность, инициативность. Пурист кода и архитектуры."));

        resume.getSections().put(SectionType.ACHIEVEMENT, new Resume.ListSection(Arrays.asList(
        ...
        resume.getSections().put(SectionType.QUALIFICATIONS, new Resume.ListSection(Arrays.asList(
        ...
        resume.getSections().put(SectionType.EXPERIENCE, new Resume.CompanySection(Arrays.asList(
                new Resume.CompanyBlock("Java Online Projects", "http://javaops.ru/",
                        List.of(new Resume.Period(
                                LocalDate.parse("2013-10-01"),
                                null,
                                "Автор проекта.",
                                "Создание, организация и проведение Java онлайн проектов и стажировок."))),
                new Resume.CompanyBlock("Wrike", "https://www.wrike.com/",
                        List.of(new Resume.Period(
                ...
                new Resume.CompanyBlock("RIT Center", null,
                        List.of(new Resume.Period(
                ...
                new Resume.CompanyBlock("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/",
                        List.of(new Resume.Period(
                ...
                new Resume.CompanyBlock("Yota", "https://www.yota.ru/",
                        List.of(new Resume.Period(
                ...
                new Resume.CompanyBlock("Enkata", "http://enkata.com/",
                        List.of(new Resume.Period(
                ...
                new Resume.CompanyBlock("Siemens AG", "https://www.siemens.com/ru/ru/home.html",
                        List.of(new Resume.Period(
                                ...
                                "Разработка информационной модели, проектирование интерфейсов, реализация и отладка " +
                                        "ПО на мобильной IN платформе Siemens @vantage (Java, Unix)."))),
                new Resume.CompanyBlock("Alcatel", "http://www.alcatel.ru/",
                        List.of(new Resume.Period(
        ...
        resume.getSections().put(SectionType.EDUCATION, new Resume.CompanySection(Arrays.asList(
                new Resume.CompanyBlock("Coursera", "https://www.coursera.org/course/progfun",
                        List.of(new Resume.Period(
                                LocalDate.parse("2013-05-01"),
                                LocalDate.parse("2013-03-01"),
                                "'Functional Programming Principles in Scala' by Martin Odersky"))),
                new Resume.CompanyBlock("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                        List.of(new Resume.Period(
                                LocalDate.parse("2011-03-01"),
                                LocalDate.parse("2011-04-01"),
                                "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.'"))),
                new Resume.CompanyBlock("Siemens AG", "http://www.siemens.ru/",
                        List.of(new Resume.Period(
                                LocalDate.parse("2005-01-01"),
                ...
                new Resume.CompanyBlock("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики",
                        "http://www.ifmo.ru/",
                        Arrays.asList(new Resume.Period(
                ...
                new Resume.CompanyBlock("Заочная физико-техническая школа при МФТИ", "https://mipt.ru/",
                        List.of(new Resume.Period(
        ...
        ((Resume.ListSection) resume.getSections().get(SectionType.ACHIEVEMENT)).getTexts().forEach(System.out::println);
        System.out.println(SectionType.QUALIFICATIONS);
        ((Resume.ListSection) resume.getSections().get(SectionType.QUALIFICATIONS)).getTexts().forEach(System.out::println);
        System.out.println(SectionType.EXPERIENCE);
        ((Resume.CompanySection) resume.getSections().get(SectionType.EXPERIENCE)).getBlocks().forEach(System.out::println);
        System.out.println(SectionType.EDUCATION);
        ((Resume.CompanySection) resume.getSections().get(SectionType.EDUCATION)).getBlocks().forEach(System.out::println);
    }
}
